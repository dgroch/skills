...
- Ask only for missing qualification gates: current-round delivery eligibility, agreement to create and supply around five high-resolution aesthetic still photographs, and brief preference/understanding. State that no Reel is required for new selections.
- Preserve existing in-flight agreements: previously confirmed Reels or Daniel-approved alternative formats remain valid; do not retroactively ask those creators to switch deliverables.
...
- Treat a clear campaign-specific commitment to create and supply the requested photo set as satisfying the creative-output gate. Generic photography capability or portfolio text is not enough. For existing in-flight threads, preserve previously agreed Reel or approved alternative output evidence.
...
- `creative_format_question`: creator asks about photo composition, crop, editing, supplied files or posting. Current approved answer: keep the work natural and true to the creator's style; aim for a mix of bouquet hero, close-detail and lifestyle/context images; supply original high-resolution files without watermarks or baked-in text; light colour correction is fine. The campaign brief must explicitly say whether the photos are supplied, posted as a static/carousel, or both.
...
8. If latest inbound fully confirms current-round delivery eligibility, agreement to create and supply around five high-resolution aesthetic photographs, and brief preference/understanding, mark them qualified/approved in the audit state regardless of cadence fullness. No Reel is required for new selections. Preserve previously agreed Reel or Daniel-approved alternative deliverables in existing threads. Current approved delivery regions: Melbourne/Sydney/Brisbane metro plus Geelong, Bannockburn, Sunshine Coast, and Gold Coast. Edge regions ship by overnight courier in a large box.
