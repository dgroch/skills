/**
 * hero-c1-clay — Split Hero, Photo Left / Text Right, Clay
 *
 * 50/50 split (300+300), fixed 440px height.
 * Photo left, clay (#D8CCBE) text column right.
 * Illustration BodyFlower_Black at right:-16px, bottom:-20px, opacity 18%.
 *
 * @param {Object} opts
 ...
 */
module.exports = function renderHeroC1Clay(opts) {
  const {
    superLabel = '',
    headline = '',
    subheadline = '',
...
<table width="600" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="hc" width="300" valign="top" style="width:300px;height:440px;padding:0;overflow:hidden;vertical-align:top;">
    ...
    </td><td class="hc" width="300" valign="middle" style="width:300px;height:440px;background:#D8CCBE;padding:40px 36px;vertical-align:middle;position:relative;overflow:hidden;border-left:1px solid #e8e2da;">
      <img src="{{ASSETS_BASE}}/BodyFlower_Black.png" width="auto" alt="" style="position:absolute;right:-16px;bottom:-20px;height:262px;width:auto;opacity:0.18;display:block;">
      <p style="font-family:'NeuzeitGro','Gill Sans','Gill Sans MT',Calibri,sans-serif;font-weight:700;font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:#888877;margin:0 0 20px 0;position:relative;z-index:1;">{{SUPER_LABEL}}</p>
      ...
      <p style="font-family:'NeuzeitGro','Gill Sans','Gill Sans MT',Calibri,sans-serif;font-weight:300;font-size:12px;color:#555544;line-height:1.75;margin:0 0 28px 0;text-align:left;max-width:190px;position:relative;z-index:1;">{{SUBHEADLINE}}</p>
