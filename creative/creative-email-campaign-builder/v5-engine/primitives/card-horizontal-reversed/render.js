/**
 * Primitive: card-horizontal-reversed
 *
 * Horizontal product card — INFO LEFT / IMAGE RIGHT.
 * Info panel 320px, image 280×350px (4:5).
 * Alternate with card-horizontal for visual rhythm.
 *
 * @param {object} opts
 ...
 */
module.exports = function renderCardHorizontalReversed(opts = {}) {
  const {
    productImage,
    productName,
    productLabel,
  ...
  if (!productImage) {
    throw new Error('[card-horizontal-reversed] productImage is required');
  }

  return `<tr><td style="border-top:1px solid ${borderColor};">
<table width="600" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="hinfo" valign="middle" style="padding:32px 32px 32px 28px;vertical-align:middle;">
    ...
    </td><td class="hi" width="280" valign="top" style="width:280px;height:350px;padding:0;overflow:hidden;vertical-align:top;">
