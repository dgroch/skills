/**
 * hero-c1 — Split Hero, Photo Left / Text Right, White
 *
 * 50/50 split (300+300), fixed 440px height.
 * Photo left, white text column right.
 ...
 */
module.exports = function renderHeroC1(opts) {
  const {
    superLabel = '',
    headline = '',
    subheadline = '',
...
<table width="600" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="hc" width="300" valign="top" style="width:300px;height:440px;padding:0;overflow:hidden;vertical-align:top;">
    ...
    </td><td class="hc" width="300" valign="middle" style="width:300px;height:440px;background:#ffffff;padding:40px 36px;vertical-align:middle;position:relative;overflow:hidden;border-left:1px solid #e8e2da;">
      ...
      <p style="font-family:'NeuzeitGro','Gill Sans','Gill Sans MT',Calibri,sans-serif;font-weight:700;font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:#aaaaaa;margin:0 0 20px 0;position:relative;z-index:1;">{{SUPER_LABEL}}</p>
      ...
      <p style="font-family:'NeuzeitGro','Gill Sans','Gill Sans MT',Calibri,sans-serif;font-weight:300;font-size:12px;color:#666666;line-height:1.75;margin:0 0 28px 0;text-align:left;max-width:190px;position:relative;z-index:1;">{{SUBHEADLINE}}</p>
