/**
 * hero-d-white — Dark Hero, Type-Forward, No Photo, White
 *
 * No photography — type and flanking illustrations only.
 * Fixed 500px height. White (#fff) bg.
 * Flanking HandRose_Black illustrations at height:410px, opacity 18%/14%.
 ...
 */
module.exports = function renderHeroDWhite(opts) {
  const {
    superLabel = '',
    headline = '',
    subheadline = '',
...
<table width="600" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="ud" align="center" valign="middle" bgcolor="#ffffff"
        style="background:#ffffff;height:500px;padding:72px 64px;text-align:center;position:relative;overflow:hidden;vertical-align:middle;">
      <img src="{{ASSETS_BASE}}/HandRose_Black.png" alt="" style="position:absolute;left:-16px;bottom:-60px;height:410px;width:auto;opacity:0.18;display:block;">
      <img src="{{ASSETS_BASE}}/HandRose_Black.png" alt="" style="position:absolute;right:-16px;bottom:-60px;height:410px;width:auto;opacity:0.14;display:block;transform:scaleX(-1);">
      <p style="font-family:'NeuzeitGro','Gill Sans','Gill Sans MT',Calibri,sans-serif;font-weight:700;font-size:9px;letter-spacing:.22em;text-transform:uppercase;color:#aaaaaa;margin:0 0 24px 0;position:relative;z-index:1;">{{SUPER_LABEL}}</p>
      ...
      <p style="font-family:'NeuzeitGro','Gill Sans','Gill Sans MT',Calibri,sans-serif;font-weight:300;font-size:13px;color:#666666;max-width:300px;margin:0 auto 32px auto;line-height:1.75;position:relative;z-index:1;">{{SUBHEADLINE}}</p>
