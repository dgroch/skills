/**
 * hero-b-clay — Text Above Image, Clay Band
 *
 * Text band (#D8CCBE bg) on top + full-bleed photo (600×360px) below.
 ...
 */
module.exports = function renderHeroBClay(opts) {
  const {
    superLabel = '',
    headline = '',
    subheadline = '',
...
<table width="600" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td bgcolor="#D8CCBE" style="background:#D8CCBE;padding:48px 48px 40px;text-align:center;position:relative;overflow:hidden;">
      ...
      <p style="font-family:'NeuzeitGro','Gill Sans','Gill Sans MT',Calibri,sans-serif;font-weight:700;font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:#888877;margin:0 0 18px 0;position:relative;z-index:1;">{{SUPER_LABEL}}</p>
      ...
      <p style="font-family:'NeuzeitGro','Gill Sans','Gill Sans MT',Calibri,sans-serif;font-weight:300;font-size:13px;color:#555544;max-width:360px;margin:0 auto 28px auto;line-height:1.75;position:relative;z-index:1;">{{SUBHEADLINE}}</p>
