/**
 * hero-b-50clay — Text Above Image, 50% Clay Band
 *
 * Text band (#EBE5DF bg, 50% clay) on top + full-bleed photo (600×360px) below.
 * Illustration BodyFlower_Black anchored right:0, bottom:-30px at 14% opacity.
 *
 * @param {Object} opts
 ...
 */
module.exports = function renderHeroB50Clay(opts) {
  const {
    superLabel = '',
    headline = '',
    subheadline = '',
...
<table width="600" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td bgcolor="#EBE5DF" style="background:#EBE5DF;padding:48px 48px 40px;text-align:center;position:relative;overflow:hidden;">
      <img src="{{ASSETS_BASE}}/BodyFlower_Black.png" alt="" style="position:absolute;right:0;bottom:-30px;width:220px;height:auto;opacity:0.14;display:block;">
      <p style="font-family:'NeuzeitGro','Gill Sans','Gill Sans MT',Calibri,sans-serif;font-weight:700;font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:#999988;margin:0 0 18px 0;position:relative;z-index:1;">{{SUPER_LABEL}}</p>
      ...
      <p style="font-family:'NeuzeitGro','Gill Sans','Gill Sans MT',Calibri,sans-serif;font-weight:300;font-size:13px;color:#666655;max-width:360px;margin:0 auto 28px auto;line-height:1.75;position:relative;z-index:1;">{{SUBHEADLINE}}</p>
