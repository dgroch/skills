...
- `operations/operations-bower-launch-control` (`operations-bower-launch-control`): Operate Bower launch control for brand separation, value bundles, CAC payback, and phase-gated growth.
- `operations/operations-growth-control-loop` (`operations-growth-control-loop`): Run Conductor's KPI dashboard, OODA review, budget reallocation, and phase-gate operating cadence.
...
- `publicity/publicity-earned-media-engine` (`publicity-earned-media-engine`): Build founder POV, data-PR, media-list, journalist-pitch, and evidence-led earned media packages.

### Partnerships

- `partnerships/partnerships-gifting-pipeline` (`partnerships-gifting-pipeline`): Scout, qualify, track, and model complementary gifting partners for Broker, Ledger, and Bower Ops.

### Lifecycle

- `lifecycle/lifecycle-birthday-club-flow` (`lifecycle-birthday-club-flow`): Design Birthday Club, recipient-card, reminder, backend, and lifecycle cohort flows.

### Occasion

- `occasion/occasion-sympathy-curation` (`occasion-sympathy-curation`): Build and review sympathy, get-well, bereavement, funeral, and care occasion collections.

### Corporate

- `corporate/corporate-recurring-gifting-program` (`corporate-recurring-gifting-program`): Build corporate recurring gifting, EOFY, quote, and invoice-flow programs.

### Reference

- `reference/reference-brand-separation-guardrail` (`reference-brand-separation-guardrail`): Keep Fig & Bloom and Bower distinct across copy, creative, offers, reporting, and customer promises.
- `reference/reference-brand-voice-guardrail` (`reference-brand-voice-guardrail`): Enforce AU English, banned-word, punctuation, sensitivity, and brand-positioning rules.
...
- `reference/reference-pr-ethics-guardrail` (`reference-pr-ethics-guardrail`): Enforce evidence, disclosure, privacy, testimonial, and no-fake-quote rules for public claims.
- `reference/reference-puppeteer` (`reference-puppeteer`): Puppeteer reference workflows and examples.
- `reference/reference-spend-discipline-guardrail` (`reference-spend-discipline-guardrail`): Enforce Phase 0 CAC ceiling, payback, margin, and budget stop-loss checks.
...
- `creative/creative-creator-ugc-engine` (`creative-creator-ugc-engine`): Run creator gifting, Hashgifted, outreach, testimonial reel, rights, and paid/social asset handoff workflows.
